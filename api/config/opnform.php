...
return [
    ...
    'mcp' => [
        ...
        'rate_limit' => [
            ...
            'draft_preview_requests_per_minute' => (int) env('MCP_DRAFT_PREVIEW_REQUESTS_PER_MINUTE', 240),
            'draft_handoffs_per_minute' => (int) env('MCP_DRAFT_HANDOFFS_PER_MINUTE', 120),
            'draft_editor_requests_per_minute' => (int) env('MCP_DRAFT_EDITOR_REQUESTS_PER_MINUTE', 240),
            'draft_proxy_pool_per_minute' => (int) env('MCP_DRAFT_PROXY_POOL_PER_MINUTE', 6000),
